...
from Ankit import TEMP_DOWNLOAD_DIRECTORY as path
from Ankit import TEMP_DOWNLOAD_DIRECTORY
from datetime import datetime
water = './Ankit/resources/ankit.jpg'
client = tbot
...
async def Prof(event):
    ...
    the_plugin_file = "./Ankit/modules/{}.py".format(input_str)
...
from Ankit.events import load_module
import asyncio
import os
from datetime import datetime
        ...
        try:
            downloaded_file_name = (
                await event.client.download_media(  # pylint:disable=E0602
                    ...
                    "Ankit/modules/",  # pylint:disable=E0602
                )
            )
...
from Ankit import telethn as tbot, OWNER_ID, DEV_USERS
from Ankit.events import register
import os
import asyncio
import os
